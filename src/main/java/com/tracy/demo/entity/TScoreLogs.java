...
public class TScoreLogs implements java.io.Serializable {
	...
	/** minimal constructor */
	public TScoreLogs(Integer creditLogId, String createdBy,
	...
	/** full constructor */
	public TScoreLogs(Integer creditLogId, Double amount, String createdBy,
			Timestamp createdDate, String creditMode, String currency,
			Integer customerId, Double dstAmount, String flag,
